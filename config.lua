-- The Forgotten Server Config
	...
	startupTime = 351
		-- quantas horas ser�o ao ligar o server (360 = 6:00 a.m, 1080 = 6:00 p.m, varia de 0 a 1440)
	startupLight = 40
	...
	motd = "Bienvenido a PokeRetro!"
	displayOnOrOffAtCharlist = false
	onePlayerOnlinePerAccount = false
	allowClones = true
	serverName = "PokeRetro"
	loginMessage = "[PokeRetro] Bienvenido a PokeRetro! Que comience tu aventura Pokemon!"
