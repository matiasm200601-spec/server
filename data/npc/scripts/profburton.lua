...
if getPlayerStorageValue(cid, 200) >= 1 then
selfSay('Hola again ' .. getCreatureName(cid) .. '! Hope you enjoyed my help. Im very busy right now, come back later!')
focus = cid
else
focus = cid
talk_start = os.clock()
...
if talkState[talkUser] == 6 then
   if getPlayerLevel(cid) >= 20 then
                ...
                selfSay('You need to register more pokemon en tu Pokédex!')
                talkState[talkUser] = 0
                focus = 0
                end
                else
