...
function onCreatureSay(cid, type, msg)
	...
	if msgcontains(msg, 'hi') and focus == 0 and getDistanceToCreature(cid) <= 4 then
		...
		talk_start = os.clock()
		conv = 1
		selfSay("Hola "..getCreatureName(cid)..", mi nombre es Brock y soy Pewter, líder de gimnasio. ¿En qué puedo ayudarte?")
	return true
	end
	...
	if isDuelMsg(msg) and conv == 1 and focus == cid then
		...
		--	selfSay("Tienes already won my Boulder Badge, maybe some other day we can fight.")
		--	focus = 0
		--return true
		--end
