...
local items = {
          item1 = {2035, 2092}, -- item1 item que será pedido e que será dado na primeira troca
          item2 = {2035, 12331} -- item2 item que será pedido e que será dado na segunda troca
}
local counts = {
          count1 = {3, 1}, -- count1 quantidade que será pedido e que será dado na primeira troca
...
function creatureSayCallback(cid, type, msg)
          ...
          if msgcontains(msg, 'Chave Dungeon') then
          ...
          elseif msgcontains(msg, 'Box Especial') then
