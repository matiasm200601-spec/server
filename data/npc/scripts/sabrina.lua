...
function onCreatureSay(cid, type, msg)
	...
	if msgcontains(msg, 'hi') and focus == 0 and getDistanceToCreature(cid) <= 4 then
		...
		talk_start = os.clock()
		conv = 1
		selfSay("Hola "..getCreatureName(cid)..", mi nombre es Sabrina y soy Saffron, líder de gimnasio. ¿En qué puedo ayudarte?")
	return true
	end
	...
	if isDuelMsg(msg) and conv == 1 and focus == cid then
		...
		--	selfSay("Ya ganaste mi Medalla Pantano; quizá podamos luchar otro día.")
		--	focus = 0
		--return true
		--end
