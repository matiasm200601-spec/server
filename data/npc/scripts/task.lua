...
if getPlayerStorageValue(cid, 910000) ~= -1 and (checkTask(getPlayerStorageValue(cid, 910000), m) == false) then
   selfSay("¡Ya tienes una tarea en curso!", cid)
   talkState[cid] = 0
   return true
elseif getPlayerStorageValue(cid, 910000) ~= -1 and (checkTask(getPlayerStorageValue(cid, 910000), m) == true) then
   selfSay("¡Veo que ya terminaste la tarea! Aquí está tu recompensa.", cid)
...
if (checkTask(Check1, m) == true) then
   selfSay("Ya completaste esta tarea. ¡Elige otra!", cid)
   talkState[cid] = 1
   return true
end
selfSay("humm.. You choose kill some Kinglers, Poliwraths and Seakings... ¿Estás seguro?", cid)
talkState[cid] = 2
...
selfSay("humm.. You choose kill some Gravelers, Golems, Primeapes... ¿Estás seguro?", cid)
talkState[cid] = 3
...
selfSay("humm.. You choose kill some Electrodes, Raichus, Pikachus... ¿Estás seguro?", cid)
talkState[cid] = 4
...
selfSay("Debes derrotar a "..showTask(task1, true).." y volver conmigo. ¡Adelante!", cid)
talkState[cid] = 0
...
selfSay("Debes derrotar a "..showTask(task2, true).." y volver conmigo. ¡Adelante!", cid)
talkState[cid] = 0
...
selfSay("Debes derrotar a "..showTask(task3, true).." y volver conmigo. ¡Adelante!", cid)
talkState[cid] = 0
