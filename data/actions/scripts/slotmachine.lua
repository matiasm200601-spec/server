...
doPlayerSendTextMessage(cid, MESSAGE_STATUS_CONSOLE_BLUE, "Por favor, permanece frente a la máquina tragamonedas para jugar.")
return true
end
...
doPlayerSendTextMessage(cid, MESSAGE_STATUS_CONSOLE_BLUE, "No tienes suficientes monedas de casino para jugar en la máquina tragamonedas.")
return true
end
local mymoney = getPlayerStorageValue(cid, coins)
setPlayerStorageValue(cid, coins, mymoney - cost)
doPlayerSetNoMove(cid, true)
doPlayerSendTextMessage(cid, MESSAGE_STATUS_CONSOLE_BLUE, "Accionaste la palanca (-10 monedas), ahora te quedan "..mymoney - cost.." monedas.")
local a = item.itemid
...
addEvent(doPullBack, 500, topos)
	...
	if checkPrize({first, second, third}) == "jackpot" then
        ...
        addEvent(doPlayerSendTextMessage, 2500, cid, MESSAGE_STATUS_CONSOLE_BLUE, "Ganaste 1000 monedas de casino; ahora tienes "..win.." monedas.")
	...
	local prize = checkPrize({first, second, third})
        ...
        addEvent(doPlayerSendTextMessage, 500, cid, MESSAGE_STATUS_CONSOLE_BLUE, "Ganaste "..prize.." monedas de casino; ahora tienes "..win.." monedas.")
