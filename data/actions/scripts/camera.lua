function onUse(cid, item, frompos, item2, topos)
	...
	if getPlayerStorageValue(cid, 99284) == 2 then
		doPlayerSendCancel(cid, "Tienes to close your private chat to create a TV channel.")
	return true
	end

	if getPlayerStorageValue(cid, 99284) == 1 then
		doPlayerSendCancel(cid, "¡Ya estás al aire! Currently on channel: "..getPlayerStorageValue(cid, 99285).."")
