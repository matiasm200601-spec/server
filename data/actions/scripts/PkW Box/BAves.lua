...
[13196] = {balltype = "ultra", ballid = 11829,
        pokemons = {"Zapdos", "Moltres", "Articuno"}}
}
...
function onUse(cid, item, frompos, item2, topos)
         ...
         doPlayerSendTextMessage(cid, 27, "Voce a box lendaria"..item.itemid - (11637).."!")
	     doPlayerSendTextMessage(cid, 27, "Ooh voce conseguiu um "..pokemon..", Parabens!")
