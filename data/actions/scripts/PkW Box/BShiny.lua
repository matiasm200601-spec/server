...
[13194] = {balltype = "ultra", ballid = 11829,
        pokemons = {"Shiny Arcanine", "Shiny Venomoth", "Shiny Raticate", "Shiny Machoke", "Shiny Dewgong", "Shiny Charmeleon"}}
}
...
function onUse(cid, item, frompos, item2, topos)
         ...
         doPlayerSendTextMessage(cid, 27, "Voce Abriu a"..item.itemid - (11637).."!")
