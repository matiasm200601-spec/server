function onUse(cid, item, frompos, item2, topos)
	...
	if item.uid == 10501 then
 	queststatus = getPlayerStorageValue(cid,987570)
 	if queststatus == -1 then
 	doPlayerSendTextMessage(cid,22,"Você completou achou uma Chave de Prata... Existem quatro no total!")
 	doPlayerAddItem(cid,2088,1)
 	doTeleportThing(cid,{x=1941, y=734, z=7})
