...
if getGlobalStorageValue(22550) >= 1 and getGlobalStorageValue(22548) <= 0 then
   if start then
      doBroadcastMessage("¡La Arena Dorada comenzó!")    
   end
   ...
   setGlobalStorageValue(22547, wave+1) 
    ...
    if start then                                                    
       doBroadcastMessage("¡La Arena Dorada no comenzó porque no había jugadores!")
       return true
    end
end
end
...
if not onStart then
   doBroadcastMessage("¡La Arena Dorada terminó!")
end
end
------------------------------------------------------------------------------------------------------------------
