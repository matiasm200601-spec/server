...
if #msg == 1 then
   return doPlayerSendTextMessage(cid, 27, "No gastaste ninguna Poké Ball intentando capturar a "..name..".")
end
...
if(param == '') then
    doPlayerSendTextMessage(cid, 27, "Escribe el nombre de un Pokémon...")
    return true
end
...
if newpokedex[doCorrectPokemonName(param)] then
   ...
   doPlayerSendTextMessage(cid, 27, "Esto no es un Pokémon...")
end
return true
end