...
function onSay(cid, words, param, channel)
	...
	doPlayerSendTextMessage(cid, MESSAGE_STATUS_CONSOLE_BLUE, "Necesitas un Pokémon para consultar los tiempos de espera.")
	return 0
	end
	...
	if getCreatureName(mypoke) == "Ditto" then
		if not isTransformed(mypoke) then
			doPlayerSendTextMessage(cid, MESSAGE_STATUS_CONSOLE_BLUE, "Tu Ditto debe transformarse primero.")
		return true
		end
	end
