...
doPlayerSendTextMessage(cid,27,"Has golpeado algo.")
setCarStatus(cid,0)
...
doPlayerSendCancel(cid,"El automóvil está a su velocidad máxima.")
end
else
doPlayerSendCancel(cid,"Primero debes empezar a moverte.")
end
...
doPlayerSendCancel(cid,"El automóvil está a su velocidad mínima.")
end
else
doPlayerSendCancel(cid,"Primero debes empezar a moverte.")
end
...
doPlayerSendCancel(cid,"El automóvil ya está detenido.")
end
...
doPlayerSendCancel(cid,"El automóvil ya está en movimiento.")
end
end
