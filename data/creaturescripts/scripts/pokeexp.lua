       ...
       for _, sid in ipairs(getPlayersOnline()) do
           if isPlayer(sid) and getPlayerStorageValue(sid, 22545) == 1 then
              if getGlobalStorageValue(22547) < #wavesGolden+1 then
                 doPlayerSendTextMessage(sid, 20, "Oleada "..wave.." comenzará en "..timeToWaves.." segundos!")   
                 doPlayerSendTextMessage(sid, 28, "Oleada "..wave.." comenzará en "..timeToWaves.." segundos!") 
              ...
              elseif getGlobalStorageValue(22547) == #wavesGolden+1 then
                 doPlayerSendTextMessage(sid, 20, "¡Ganaste la Arena Dorada! ¡Toma tu recompensa!")
