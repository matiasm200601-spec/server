...
table.insert(str, "Holding: "..(yhelds[heldy].name)..". ")
   ...
   elseif string.find(iname.name, "fainted") or string.find(iname.name, "defeated") then     
      ...
      table.insert(str, "Ves a "..string.lower(iname.name)..". ")     
   ...
   elseif isContainer(thing.uid) then     --containers
      ...
      if iname.name == "dead human" and getItemAttribute(thing.uid, "pName") then
         table.insert(str, "Ves a dead human (Vol:"..getContainerCap(thing.uid).."). ")
      ...
      if getPlayerGroupId(cid) >= 4 and getPlayerGroupId(cid) <= 6 then
         ...
         table.insert(str, "\nPosición: [X: "..pos.x.."][Y: "..pos.y.."][Z: "..pos.z.."]")  
      end
      doPlayerSendTextMessage(cid, MESSAGE_INFO_DESCR, table.concat(str))
      return false
...
if not isSummon(thing.uid) then   --monstros
   ...
   table.insert(str, "Ves a wild "..string.lower(getCreatureName(thing.uid))..".\n")
...
elseif isSummon(thing.uid) and not isPlayer(thing.uid) then  --summons
   ...
   if getCreatureMaster(thing.uid) == cid then
      ...
      doPlayerSendTextMessage(cid, MESSAGE_INFO_DESCR, "Ves a "..string.lower(getCreatureName(thing.uid))..".\nPertenece a "..getCreatureName(getCreatureMaster(thing.uid))..".")
   end
   return false
end
return true
